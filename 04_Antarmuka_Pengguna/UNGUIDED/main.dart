...
class WisataPage extends StatelessWidget {
  final List<Wisata> wisataList = [
    ...
    Wisata(
      ...
      deskripsi:
          'Desa Wisata Melung memiliki keunikan yang sangat berbeda dengan Desa Wisata lainya, keunikan tersebut diantarnya adalah warga masyarakat masih tetap memegang teguh adat istiadat jawa kuno, tidak hanya itu Desa Wisata Melung juga memiliki keunggulan yang juga tidak kalah dengan desa wisata lainya, selain panaorama alam yang sangat indah Desa Wisata Melung memiliki kolam renang tengah sawah dengan sumber mata air langsung dari mata air/tuk, sehingga air tetap bersih walaupun tidak menggunakan kaporit.',
      imageUrl:
